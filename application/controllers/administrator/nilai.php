...
class Nilai extends CI_Controller{
	...
	public function nilai_aksi()
	{
		...
		if($this->form_validation->run() == FALSE) {
			...
			$query = "SELECT krs.id_thn_akad,krs.kode_matakuliah,matakuliah.nama_matakuliah,matakuliah.sks,krs.nilai
			...
			$query_str = "SELECT mahasiswa.nim, mahasiswa.nama_lengkap, prodi.nama_prodi
						FROM
						mahasiswa
						INNER JOIN prodi
